@echo off
REM Run Windows Network Manager in manual/console mode with custom port
REM Usage: run_manual_port.bat [port]
REM Example: run_manual_port.bat 18081
...
echo ========================================
echo.
echo This will run the application in console mode on port %PORT%.
...
echo Starting Windows Network Manager on port %PORT%...
echo.
...
REM Run the application with custom port
WindowsNetworkManager.exe -port %PORT%
